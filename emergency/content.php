...
$query = "SELECT * FROM amritsar_record WHERE Amritsar_record_id=$test";
...
while($row= mysqli_fetch_array($result)) {
	if(!empty($row['city'])){
		...
		$victim_details="restricted";
		$culprit_details="restricted";
		?>
		<script
...
<table style="position:absolute; top:900px; left:50%; margin-left:-500px;" width="1000" border="1">
  ...
  <tr>
    <td style="text-align:right; padding-right:20px;">Victim Details</td>
    <td style="text-align:left; padding-left:10px;"><?php echo $victim_details?></td>
    <td style="text-align:right; padding-right:20px;">Culprit Details</td>
    <td style="text-align:left; padding-left:10px;"><?php echo $culprit_details?></td>
  </tr>
